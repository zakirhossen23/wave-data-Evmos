...
class RegisterApp extends State<RegisterModal> {
  ...
  Future<void> RegisterAccount() async {
    var url = Uri.parse('https://wavedata-api-evmos.netlify.app/api/GET/checkEmail?email=${Uri.encodeComponent(emailTXT.text)}');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
    if (responseData['value'] == "False") {
      var urlReg = Uri.parse('https://wavedata-api-evmos.netlify.app/api/POST/Register');
