...
class _QuestionnaireScreenState extends ConsumerState<QuestionnaireScreen> {
  ...
  Future<void> GetData() async {
    ...
    var url = Uri.parse(
        'https://wave-data-evmos-api.onrender.com/api/GET/Trial/Survey/GetSurveyDetails?surveyid=${surveyid}');
  ...
  Future<void> SaveData(sectionindex) async {
    ...
    var url = Uri.parse(
        'https://wave-data-evmos-api.onrender.com/api/POST/Trial/Survey/CreateSurveyAnswers');
  ...
  Future<void> FinishSurvey() async {
    ...
    var url = Uri.parse(
        'https://wave-data-evmos-api.onrender.com/api/POST/Trial/Survey/CreateCompletedSurvey');
